...
type PreferencesConfiguration struct {
	...
	close       func([]*golang.PreferenceItem)
}

func NewPreferencesConfiguration(preferences []*golang.PreferenceItem, close func([]*golang.PreferenceItem), width int) *PreferencesConfiguration {
